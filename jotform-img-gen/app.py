    ...
    with gr.Tab(f"{image_type.capitalize()} Generation"):
        ...
        with gr.Row():
            with gr.Column(scale=2):
                with gr.Accordion("Advanced Options", open=False):
                    with gr.Row():
                        ...
                        sampling_steps = gr.Slider(minimum=1, maximum=150, value=5, step=1, label="Sampling steps")
            ...
            with gr.Column(scale=4):
                ...
                with gr.Row():
                    rating = gr.Slider(minimum=1, maximum=10, step=0.5, value=5, label="Image Rating", visible=False, interactive=True)
        ...
        def _generate_image(image_type:str, img_model:str, prompt:str, negative_prompt:str, width:int, 
            ...
            if image is not None:
                return image, info, gr.update(visible=True), gr.update(visible=True)
            else:
        ...
        generate_button.click(
            ...
            outputs=[output_image, info_output, info_output, rating]
        )
